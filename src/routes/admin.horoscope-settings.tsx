  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <StatsCard title="Total Revenue" value={`₹${totalRevenue}`} icon={DollarSign} />
        <StatsCard title="Commission" value={`₹${totalCommission.toFixed(0)}`} icon={TrendingUp} />
        <StatsCard title="Delivered" value={requests.filter((r) => r.status === "Delivered").length} icon={Settings} />
      </div>
