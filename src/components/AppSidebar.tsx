...
const navByRole: Record<UserRole, NavItem[]> = {
  admin: [
    ...
    { label: "PAN Portal Settings", to: "/admin/pan-portal-settings", icon: Settings, hint: "UTI PSA + Coupon credentials, fees" },
  ...
  retailer: [
    ...
    { label: "PAN Portal (UTI)", to: "/retailer/pan-portal", icon: IdCard as any, tag: "new", hint: "UTI PSA registration & coupon purchase" },
